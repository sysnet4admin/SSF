...
winget install -e --id Oracle.VirtualBox -v 7.2.4
...
### virtualbox v7.1.10
brew install --cask ./virtualbox-v7.2.4/virtualbox.rb
...
winget install -e --id Hashicorp.Vagrant -v 2.4.9
...
### vagrant v2.4.7
brew install --cask ./vagrant-v2.4.9/vagrant.rb
...
winget install -e --id Eugeny.Tabby -v 1.0.229
...
### tabby v1.0.207
brew install --cask ./tabby-v1.0.229/tabby.rb
...
## Windows
cp ./tabby-v1.0.229/config.yaml $env:APPDATA/tabby/

## MacOS
cp ./tabby-v1.0.229/config.yaml ~/Library/Application\ Support/tabby/
